    ...
    <Carousel
      ...
      <div className='w-[100%] h-[88vh] flex items-center justify-center flex-col bg-blue-950 
        ...
        <div className='w-[80%] grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-[1rem] mx-auto'>
          ...
          <div>
            ...
            <p className='mt-[1rem] text-white text-opacity-70 text-[18px]'>Lorem ipsum dolor sit amet consectetur
              adipisicing elit. Iste nihil unde maiores cupiditate perferendis asperiores similique in
              dolor quis voluptatum velit accusantium, ab alias possimus.</p>
            <button className='mt-[2rem] px-8 py-3 sm:px-8 sm:py-3 text-[14px] sm:text-[16px] bg-green-500 transition-all duration-200 hover:bg-green-700 flex items-center rounded-md space-x-2 text-white'>
              <span>
      ...
      <div className='w-[100%] h-[88vh] flex items-center justify-center flex-col bg-red-950 
        ...
        <div className='w-[80%] grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-[1rem] mx-auto'>
          ...
          {/* information */}
          <div>
            <h1 className='text-[40px] font-semibold text-yellow-400'>Testy Burger </h1>
            <h1 className='text-[90px] leading-[5rem] uppercase text-white font-bold'>Top <br /> Burgers</h1>
            <p className='mt-[1rem] text-white text-opacity-70 text-[18px]'>Lorem ipsum dolor sit amet consectetur
              adipisicing elit. Iste nihil unde maiores cupiditate perferendis asperiores similique in
              dolor quis voluptatum velit accusantium, ab alias possimus.</p>
            <button className='mt-[2rem] px-8 py-3 sm:px-8 sm:py-3 text-[14px] sm:text-[16px] bg-blue-500 transition-all duration-200 hover:bg-green-700 flex items-center rounded-md space-x-2 text-white'>
              <span>
                <BiCycling className='w-[1.7rem] h-[1.7rem]' />
              </span>
              <span className='font-bold'>Order Now</span>
