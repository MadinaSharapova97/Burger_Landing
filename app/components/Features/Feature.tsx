...
const Feature = () => {
    return (
        <div className='pt-[5rem] pb-[3rem]'>
            ...
            {/* Heading */}
            <h1 className='heading'>burgers made with <br />
            ...
            md:grid-cols-2 lg:grid-cols-3 gap-[3rem]'>
                {/* 1st card */}
                <div data-aos="fade-left" data-aos-anchor-pacement="top-center">
                    <div className='p-6 hover:bg-white rounded-lg transition-all duration-200'>
                        ...
                        <p className='mt-[0.2rem] text-black text-opacity-60 text-center'>Lorem ipsum dolor, sit amet
                            consectetur adipisicing elit. Aspernatur quaerat
                            magnam iste ullam quidem ipsum voluptate
                            molestiae, dignissimos deleniti quasi.</p>
                    </div>
                </div>
                {/* 2nd card */}
