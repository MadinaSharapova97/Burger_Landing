    ...
    return (
        <div className='bg-green-700 p-6 rounded-lg'>
            ...
            <div className='mt-[2rem]'>
                <div className='flex flex-col sm:flex-row space-y-3 sm:space-y-3 items-center w-[80%] mx-auto justify-between space-x-4'>
                    <select
                        className='px-10 py-2.5 bg-transparent rounded-lg outline-none font-bold text-[17px] text-white border-gray-100'
                        name="people"
                        id="people">
                        <option value="1" className='text-black'>People</option>
                        <option value="2" className='text-black'>People</option>
                        <option value="3" className='text-black'>People</option>
                        <option value="4" className='text-black'>People</option>
                    </select>
                ...
                <input type="time" className='px-10 py-2.5 bg-transparent block w-[80%] mx-auto mt-[1rem] rounded-lg outline-none 
