        ...
        <div className="pt-[5rem] bg-center bg-cover relative mt-[2rem] pb-[5rem] mb-[3rem] bg-[url('/images/bg-black.jpg')]">
            ...
            <div className='w-[80%] relative z-[20] mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-[3rem]'>
                ...
                <div>
                    ...
                    <p className='text-[17px] text-white text-opacity-50'>Lorem ipsum dolor sit amet
                        consectetur adipisicing elit. Ab sunt
                        commodi natus molestiae ducimus laboriosam
                        dolores. Rem earum libero recusandae
                        consequuntur. Veritatis velit accusantium eveniet.</p>
                    <div className='flex mt-[2rem] items-center space-x-4'>
                        ...
                        <div>
                            ...
                            <h1 className='text-yellow-300 text-[30px] font-bold'>+123 456 789</h1>
                        </div>
                    </div>
                </div>
                <ReservationForm/>
